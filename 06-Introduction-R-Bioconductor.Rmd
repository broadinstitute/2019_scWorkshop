...
ec2-<AWS PUBLIC IP ADDRESS>.us-west-2.compute.amazonaws.com
ec2-54-202-32-102.us-west-2.compute.amazonaws.com
...
numeric_matrix <- matrix(sample(1:10, 1000, replace = TRUE), nrow = 10, ncol = 10)
numeric_matrix
...
```{r}
sparse_matrix <- pbmc_small@data[1:20, ]
```
