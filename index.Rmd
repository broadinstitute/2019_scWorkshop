...
#### Lecture 1 – scRNA-Seq experimental design (1 hour, Orr) 
...
#### Lab 1 –  Understanding sequencing raw data (Kirk, 1.5-2 hours)
...
#### Lecture 2 - Intro to Data processing: from bcl file to bam file (1 hour, Dana)
...
#### Lab 2 – Processing raw scRNA-Seq data (Dana, no R at this point)
...
Chapters 3 and 4? Are there parts that supposed to be in labs 1 or 3? 
...
#### Lecture 3 – Transcriptome quantification: from bam file to counts (Orr)
...
#### Lecture 4 - Expression QC, normalisation and batch correction (Dana)
...
Sigantures? 
http://hemberg-lab.github.io/scRNA.seq.course/introduction-to-rbioconductor.html
9.1 - 9.5?
...
#### Lecture 5 - Identifying cell populations (Kirk)
Feature selection
...
#### Lecture 6 - Introduction to batch effects (Orr)
...
#### Lecture 7 - Advanced topics: Functional analysis of cell sub-populations (Kirk 30 min) 
Gene sets and signatures
Pathway analysis
inferCNV / honeybadger

#### Lecture 7 - Advanced topics: Pseudotime cell trajectories (Kirk 30 min)
Waddington Landscape
Pseudotime inference
Differential expression through pseudotime
Lecture 7 - Advanced topics: Spatial genomics, multiplexing? (Kirk 30 min)

#### Lab 8 - Functional and Pseudotime analysis (Orr)
...
#### Lecture 8 - Single-cell multiomic technologies (Dana)
...
#### Lab 9 - Analysis of CITE-seq, scATAC-seq (Orr, may be time-limited)
...
#### Lab 10 - small dataset for analysis (Dana) 
